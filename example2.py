...
def load(
    ...
    print("ckpt_dir:")
    print(ckpt_dir)
    checkpoints = sorted(Path(adapter_path).glob("*.pth"))
    ...
    print("adapter_path:")
    print(adapter_path)
    adapter_checkpoint = torch.load(adapter_path + "/llama_adapter_len10_layer30_release.pth", map_location="cpu")
    print("CHECKPOINT------")
    path = "/home/akashk4/llama/llama-2-7b/params.json"
